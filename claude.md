...
### B5. Phasing
- **Foundation — POC/Demo (28 days):** WhatsApp triage core + vendor schema on free/low-cost managed tiers; Telegram as an added alternative channel; **synthetic/sample demo data** (no live client data). Exit gate: stated POC milestones/deliverables met and board approval.
